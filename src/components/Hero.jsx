    ...
    return (
        <section className="min-h-screen flex items-center relative overflow-hidden bg-white">
            ...
            <div className="absolute top-10 right-10 z-50">
                <button
                    onClick={toggleAudio}
                    className="w-12 h-12 rounded-full border-2 border-black flex items-center justify-center hover:bg-black hover:text-white transition-all duration-300 relative group"
                >
                    {isPlaying ? (
